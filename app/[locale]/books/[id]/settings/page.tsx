...
export default function BookSettingsPage({ params }: { params: { id: string } }) {
  const t = useTranslations("bookViewer.settings")
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : t("toasts.pdfErrorDesc"),
        variant: "destructive",
      })
    } finally {
  ...
  const handleShareBook = () => {
    ...
    toast({
      ...
      description: t("toasts.shareDesc"),
    })
  }
  ...
  const handleDeleteBook = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : t("toasts.deleteErrorDesc"),
        variant: "destructive",
      })
    } finally {
      setIsDeleting(false)
  ...
  if (!book) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-4">{t("bookNotFound")}</p>
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <Badge variant="secondary" className="text-lg px-4 py-2">
            {isQuotaBypass ? t("quotaUnlimited") : t("quotaRemaining", { remaining: quotaRemaining, total: book.edit_quota_limit })}
          </Badge>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>📖 {t("bookInfoTitle")}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("themeLabel")}</p>
                <p className="font-medium capitalize">{book.theme}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">{t("illustrationStyleLabel")}</p>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>🎨 {t("editImagesTitle")}</CardTitle>
            <p className="text-sm text-muted-foreground">
              {isQuotaBypass
                ? t("editImagesDescUnlimited")
                : t("editImagesDesc", { count: quotaRemaining })}
            </p>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {book.cover_image_url && (
                <div className="border rounded-lg p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="text-xs">{t("coverLabel")}</Badge>
                  </div>
              ...
              {book.story_data?.pages?.map((page) => (
                <div key={page.pageNumber} className="border rounded-lg p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t("pageLabel", { n: page.pageNumber })}</span>
                    <Badge variant="outline" className="text-xs">{t("storyLabel")}</Badge>
                  </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>📋 {t("editHistoryTitle")}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>⚙️ {t("actionsTitle")}</CardTitle>
          </CardHeader>
