...
const illustrationStyles: IllustrationStyle[] = [
  ...
  },
  {
    ...
    iconBgColor: "bg-gradient-to-br from-red-500 to-rose-500",
  },
  {
    id: "picture_book",
    Icon: BookOpen,
    title: "Picture-Book",
    description:
      "Warm, slightly textured, inviting children's picture book illustration, soft glow, stylized but clear details",
    gradientFrom: "from-yellow-500",
    gradientTo: "to-amber-500",
    borderColor: "border-yellow-500",
    iconBgColor: "bg-gradient-to-br from-yellow-500 to-amber-500",
  },
  {
    id: "block_world",
    Icon: Grid3x3,
